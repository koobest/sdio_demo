/*
 *  Copyright (c) 2010 - 2015 Espressif System.
 *
...
#define SIP_HDR_IS_HYBRID_DATA(hdr) (SIP_HDR_GET_TYPE((hdr)->fc[0]) == SIP_HYBRID_DATA)
...
struct sip_tx_data_info {
        u8 tid;
        u8 ac;
        u8 p2p:1,  /* will cause problem in BigEndian */
           enc_flag:7;
        u8 hw_kid;
}  __packed;
...
enum esp_ieee80211_phytype {
	...
	ESP_IEEE80211_T_OFDM = 1,		/* frequency division multiplexing */
